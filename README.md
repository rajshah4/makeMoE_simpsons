...
I also have a [video walkthrough of the notebook](https://youtu.be/w9vude94TxU)

**What’s new here from Raj?**  
This repo extends the original ideas with the Simpsons dataset, richer guidance, and detailed, beginner-friendly comments in the from Scratch notebook.

---

### What is makeMoE?

makeMoE is a from-scratch implementation of a sparse mixture of experts (MoE) language model, designed for clarity, hackability, and learning. While it builds on the core concepts of makemore, this version is tailored for the Simpsons dataset and comes with expanded explanations and hands-on guidance, especially in [makeMoE_from_Scratch.ipynb](makeMoE_from_Scratch.ipynb).

### Highlights

- **Simpsons dataset**: Train and experiment with a fun, real-world dataset.
- **Step-by-step guidance**: The main notebook [makeMoE_from_Scratch.ipynb](makeMoE_from_Scratch.ipynb) is packed with comments and explanations to help you understand, modify, and extend the model.
